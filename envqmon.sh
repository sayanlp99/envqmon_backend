...
#-----------------------------------------------------------#
#home_service
    curl -X POST http://localhost:3002/api/homes \
    -H "Content-Type: application/json" \
    -d '{
    ...
    curl http://localhost:3002/api/homes/1bada3d2-5ce2-420c-8694-ae4c265548c4
...
#-----------------------------------------------------------#
# device_data_service
    curl "http://localhost:3004/api/data/range?device_id=c8f7d435-09cd-41a2-982f-b57b46075c8a&from=1704067200&to=1735670399"
    curl http://localhost:3004/api/data/latest/c8f7d435-09cd-41a2-982f-b57b46075c8a
#-----------------------------------------------------------#